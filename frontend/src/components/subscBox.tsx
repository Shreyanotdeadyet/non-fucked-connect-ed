const PersonalizedProg = () => {
  return (
    <div className="w-full bg-gray-100 flex flex-col items-center justify-center py-16">
      {/* Centered Heading */}
      <h1 className="hd-ft-teal text-center mb-8">
      ...
      <div className="w-full max-w-7xl px-4 md:w-4/5 border border-teal-300 rounded-xl bg-white p-6 flex flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-6 shadow-lg z-10">
        ...
        <div className="flex-1 border-b md:border-b-0 md:border-r border-teal-300 p-6 md:last:border-none">
          <h2 className="nom-b-ft-teal">Year of Growth Program</h2>
          ...
          <p className="nom-ft mt-4 leading-relaxed">
            <strong className="nom-b-ft-teal">Best For:</strong> Students seeking continuous support and a fully tailored path to academic and personal success.
          </p>
        </div>

        {/* Section 2: Monthly Map Program */}
        <div className="flex-1 border-b md:border-b-0 md:border-r border-teal-300 p-6 md:last:border-none">
          <h2 className="nom-b-ft-teal">Monthly Map Program</h2>
          <p className="nom-ft mt-4 leading-relaxed">
          ...
          <p className="nom-ft mt-4 leading-relaxed">
            <strong className="nom-b-ft-teal">Best For:</strong> Students who prefer a steady pace and actionable guidance in manageable, monthly steps.
          </p>
        </div>

        {/* Section 3: Pathway Accelerator Program */}
        <div className="flex-1 p-6">
          <h2 className="nom-b-ft-teal">Pathway Accelerator Program</h2>
          <p className="nom-ft mt-4 leading-relaxed">
          ...
          <p className="nom-ft mt-4 leading-relaxed">
            <strong className="nom-b-ft-teal">Best For:</strong> Students looking for a one-time boost to jumpstart their planning or resolve specific challenges.
          </p>
        </div>
      </div>
      <button className="read-more bg-pup hover:bg-dpup nom-b-ft-white py-2 px-4 rounded-xl my-6">
              Contact Us
            </button>
    </div>
  );

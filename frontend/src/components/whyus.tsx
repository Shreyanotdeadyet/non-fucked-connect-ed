...
const WhyUsSection = () => {
  const sections = [
    {
      icon: <Users size={48} className="text-[#e9e5e2]" />,
    ...
    {
      icon: <Target size={48} className="text-[#e9e5e2]" />,
    ...
    {
      icon: <Compass size={48} className="text-[#e9e5e2]" />,
    ...
    {
      icon: <Heart size={48} className="text-[#e9e5e2]" />,
  ...
  return (
    <div className="bg-black px-4 sm:px-8 lg:px-20">
      <div className="min-h-screen bg-black text-[#e9e5e2] px-8 py-16">
        {/* Title */}
        <h1 className="text-5xl font-bold text-center mb-12 animate__animated animate__fadeIn">Why Choose Us?</h1>
        <p className="text-xl text-center mb-16 max-w-2xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-8">
          {sections.map((section, index) => (
            <div
              key={index}
              className="bg-[#cbbab2] p-6 rounded-lg shadow-xl transform transition-all duration-500 hover:scale-105 hover:shadow-2xl group"
            >
              {/* Grid Content */}
              <div className="flex flex-col items-center justify-center space-y-4">
                ...
                <h2 className="text-2xl text-black font-semibold">{section.title}</h2>

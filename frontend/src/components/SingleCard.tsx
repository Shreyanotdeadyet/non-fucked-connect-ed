  ...
  const backSideContent = [
    {
      ...
      bgGradient: "bg-gradient-to-r bg-pup",
      icon: <Shield className="w-8 h-8 text-dtg-500" />,
    ...
    {
      title: "24/7 Support",
      bgGradient: "bg-gradient-to-r bg-dtg-500",
      icon: <Clock className="w-8 h-8 text-pup" />,
    ...
    },
    {
      ...
      bgGradient: "bg-gradient-to-r bg-pup",
      icon: <Heart className="w-8 h-8 text-dtg-500" />,
    ...
    },
    {
      ...
      bgGradient: "bg-gradient-to-r bg-dtg-500",
      icon: <Trophy className="w-8 h-8 text-pup" />,
